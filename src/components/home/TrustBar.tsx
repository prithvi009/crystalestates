...
export default function TrustBar() {
  return (
    <motion.section
      className="hidden md:block bg-white border-y border-border-subtle py-8 sm:py-10 overflow-hidden"
    ...
    >
      ...
      <div className="flex items-center justify-center max-w-6xl mx-auto px-6">
