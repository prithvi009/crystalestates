...
export const properties: Property[] = [
  {
    ...
    description:
      "Crystal Farmlands presents a rare investment opportunity near Saswad in Pune district. These agricultural land parcels offer flat terrain with bore well availability and are just 10 minutes from the highway. With NA conversion possibility and consistent 15%+ annual appreciation, this is an ideal investment for those looking at long-term wealth creation through land banking.",
    amenities: [
      "Bore Well",
      "Road Access",
      "Electricity",
    ...
    nearbyPlaces: [
      { name: "Pune Highway", distance: "10 min" },
